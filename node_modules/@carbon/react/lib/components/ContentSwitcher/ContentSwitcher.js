...
var ContentSwitcher = /*#__PURE__*/function (_React$Component) {
  ...
  _rollupPluginBabelHelpers.createClass(ContentSwitcher, [{
    ...
    value: function render() {
      ...
      var isIconOnly = React__default["default"].Children.map(children, function (child) {
        return child.type.displayName === 'IconSwitch';
      }).every(function (val) {
        return val === true;
      });
      var classes = cx__default["default"]("".concat(prefix, "--content-switcher"), className, (_classNames = {}, _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--content-switcher--light"), light), _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--content-switcher--").concat(size), size), _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--content-switcher--icon-only"), isIconOnly), _classNames));

...
function Tooltip(_ref) {
  ...
  var _useDelayedState = useDelayedState.useDelayedState(defaultOpen),
      _useDelayedState2 = _rollupPluginBabelHelpers.slicedToArray(_useDelayedState, 2),
      open = _useDelayedState2[0],
      setOpen = _useDelayedState2[1];

  var id = useId.useId('tooltip');
  ...
  return /*#__PURE__*/React__default["default"].createElement(index.Popover, _rollupPluginBabelHelpers["extends"]({}, rest, {
    align: align,
    className: cx__default["default"]("".concat(prefix, "--tooltip"), customClassName),
    dropShadow: false,
    highContrast: true,
    onKeyDown: onKeyDown,

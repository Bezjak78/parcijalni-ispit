...
function FileUploaderDropContainer(_ref) {
  ...
  function validateFiles(event) {
    var transferredFiles = event.type === 'drop' ? _rollupPluginBabelHelpers.toConsumableArray(event.dataTransfer.files) : _rollupPluginBabelHelpers.toConsumableArray(event.target.files);

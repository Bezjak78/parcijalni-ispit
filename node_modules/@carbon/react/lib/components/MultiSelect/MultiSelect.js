...
var _ref = Downshift.useSelect.stateChangeTypes,
...
var MultiSelect = /*#__PURE__*/React__default["default"].forwardRef(function MultiSelect(_ref2, ref) {
  var _cx, _cx2, _cx4;
  ...
  var _useSelect = Downshift.useSelect(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, downshiftProps), {}, {
  ...
  sortItems(items, sortOptions).map(function (item, index) {
    ...
    var itemProps = getItemProps((_getItemProps = {
      item: item
    }, _rollupPluginBabelHelpers.defineProperty(_getItemProps, 'aria-selected', isChecked ? true : undefined), _rollupPluginBabelHelpers.defineProperty(_getItemProps, "disabled", item.disabled), _getItemProps));
